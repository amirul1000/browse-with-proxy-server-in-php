...
<nav>
	<ul class="sidebar-menu" data-widget="tree">
        ...
        <li
			...
			<ul class="treeview-menu" <?php if($menu_open==true){?>
				...
				<li <?php if($this->router->fetch_class()=="category"){?>
					class="active" <?php }?>><a
					href="<?php echo site_url('admin/category/index'); ?>">- Category</a></li>
        ...
        <li <?php if($this->router->fetch_class()=="contact"){?>
			class="active" <?php }?>><a
			href="<?php echo site_url('admin/contact/index'); ?>"><i
				class="icon_table"></i>Contact</a></li>
		<li <?php if($this->router->fetch_class()=="content"){?>
			class="active" <?php }?>><a
			href="<?php echo site_url('admin/content/index'); ?>"><i
				class="icon_table"></i>Content</a></li>
        <li <?php if($this->router->fetch_class()=="proxy"){?>
			class="active" <?php }?>><a
			href="<?php echo site_url('admin/proxy/index'); ?>"><i
				class="icon_table"></i>Proxy</a></li>
	</ul>
</nav>
<!--End of Left Menu//-->