...
<table class="table table-striped table-bordered">
    ...
    ?>
		...
		<td><a
			href="<?php echo site_url('admin/subscriber/details/'.$c['id']); ?>"
			class="action-icon"> <i class="zmdi zmdi-eye"></i></a> <a
			href="<?php echo site_url('admin/subscriber/save/'.$c['id']); ?>"
			class="action-icon"> <i class="zmdi zmdi-edit"></i></a> <a
			href="<?php echo site_url('admin/subscriber/remove/'.$c['id']); ?>"
